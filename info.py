...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002470499382').split()] #Channel id for auto indexing ( make sure bot is admin )
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/boamovie')
